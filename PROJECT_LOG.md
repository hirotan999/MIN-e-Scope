...
### �o�[�W�����X�V�r���h (v1.2.10) - �N���[�Y�h�e�X�g����

- **����**: 2026-01-24 09:27
- **�w��**:
  1. �N���[�Y�h�e�X�g�p�ɃA�b�v�r���h�����{�B
- **���{���e**:
  1. **�o�[�W�����X�V**: ersionCode 280, ersionName "1.2.10" �ɍX�V�B
  2. **�N���[�������[�X�r���h**: ./gradlew clean --no-build-cache bundleRelease �����s�B
- **����**:
  - �����t��AAB (MIN-e_Scope_v1.2.10_...-release.aab) �̐����ɐ����B
...
## 2026-01-26 14:04
- **�w�����e��**: ���i�łɂ���̂�rule��log���悭�ǂ�ŃA�b�v�r���h���Ă�������
- **���{�������**: app/build.gradle.kts�̃o�[�W������1.2.13 (283)�ɍX�V���A���i�ŗpAAB�̃r���h�����s���܂����B
- **����**: �o�[�W�����X�V�����A�r���h���s���B


## 2026-02-02 15:45
### �w��
app-ads.txt �̐ݒ�ƃh���C���F�؂̊���

### �Ή�
1. privacy-policy/app-ads.txt���쐬���AAdMob ID���L�q�B
2. privacy-policy/index.html��Google Search Console�F�ؗp���^�^�O��ǉ��B
3. GitHub�փv�b�V�����AVercel�ւ̃f�v���C���g���K�[�B
...
### 2026-02-06 17:05 修正
- **修正**: pp-ads.txt の配置場所を修正。privacy-policy/ ディレクトリからルートディレクトリへ移動。
- **理由**: Vercel のデプロイにおいて、ルートドメインでファイルにアクセスできない問題（404エラー）を解決するため。
- **アクション**: ファイル移動およびルートディレクトリへの ercel.json 作成。

申し訳ありませんでした。ご指摘の通り、配置場所が間違っておりました。 app-ads.txt をルートディレクトリに移動し、GitHubへプッシュしました。

これで以下のURLからアクセスできるようになるはずです。 https://min-e-scope.vercel.app/app-ads.txt
